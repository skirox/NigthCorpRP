...
local blips = {
  ...
  {title="~y~blanchiment", colour=5, id=84, x = 340.93, y = -2045.12, z = 21.23}
...
function OpenBanditsActionsMenu()
  ...
  if Config.EnablePlayerManagement and PlayerData.job2 ~= nil and PlayerData.job2.grade_name == 'Capitaine' then
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if data.current.value == 'vehicle_list' then
        ...
        if Config.EnableSocietyOwnedVehicles then
              ...
              ESX.UI.Menu.Open(
                ...
                function(data, menu)
                  ...
                  ESX.Game.SpawnVehicle(vehicleProps.model, Config.Zones2.VehicleBanditsSpawnPoint.Pos, 270.0, function(vehicle)
                    ...
                    SetVehicleNumberPlateText(vehicle, "Poissonerie" .. platenum)
            ...
            local elements = {
              ...
              {label = 'Moto blanchiment', value = 'manchez'},

              {label = 'Buffalo', value = 'buffalo2'},
            ...
            if Config.EnablePlayerManagement and PlayerData.job2 ~= nil and
              ...
              (PlayerData.job2.grade_name == 'Capitaine' or PlayerData.job2.grade_name == 'capitaine') then

              table.insert(elements, {label = 'Véhicule du chef', value = 'sultan'})
                ...
                for i=1, #elements, 1 do
                  ...
                  if Config.MaxInService == -1 then
                    ...
                    ESX.Game.SpawnVehicle(data.current.value, Config.Zones2.VehicleBanditsSpawnPoint.Pos, 90.0, function(vehicle)
                      ...
                      SetVehicleNumberPlateText(vehicle, "blanchiment" .. platenum)

                      SetVehicleCustomPrimaryColour(vehicle, 100, 100, 0)

					  SetVehicleCustomSecondaryColour(vehicle, 100, 100, 0)
      ...
      if data.current.value == 'item' then
        ...
        TriggerServerEvent('esx_blanchiment:buyItem')
      ...
      if data.current.value == 'item1' then
        ...
        TriggerServerEvent('esx_blanchiment:buyItem1')
      ...
      if data.current.value == 'item2' then
        ...
        TriggerServerEvent('esx_blanchiment:buyItem2')
...
function OpenGetStocksBanditsMenu()
  ...
  ESX.TriggerServerCallback('esx_blanchiment:getStockItemsBandits', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_blanchiment:getStockItemsBandits', itemName, count)
...
ESX.TriggerServerCallback('esx_blanchiment:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_blanchiment:putStockItemsBandits', itemName, count)
  ...
  if Config.EnableArmoryManagement then
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('esx_blanchiment:giveWeaponBandits', weapon,  1000)
...
function OpenGetWeaponBanditsMenu(station)
  ...
  ESX.TriggerServerCallback('esx_blanchiment:getArmoryWeaponsBandits', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_blanchiment:removeArmoryWeaponBandits', function()
...
function OpenPutWeaponBanditsMenu(station)
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_blanchiment:addArmoryWeaponBandits', function()
  ...
  ESX.TriggerServerCallback('esx_blanchiment:getArmoryWeaponsBandits', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_blanchiment:buyBandits', function(hasEnoughMoney)
...
function OpenCryptedHarvestMenu()
  ...
  if Config.EnablePlayerManagement and PlayerData.job2 ~= nil and PlayerData.job2.grade_name ~= 'stagiaire-marin' then
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value == 'formol' then
          ...
          TriggerServerEvent('esx_blanchiment:startHarvestBandits')
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value == 'puce' then
          ...
          TriggerServerEvent('esx_blanchiment:startHarvest2Bandits')
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value == 'spark' then
          ...
          TriggerServerEvent('esx_blanchiment:startHarvest3Bandits')
        ...
        if data.current.value == 'tesla' then
          ...
          TriggerServerEvent('esx_blanchiment:startHarvest4Bandits')
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value == 'sedatif' then
          ...
          TriggerServerEvent('esx_blanchiment:startCraftBandits')
        ...
        if data.current.value == 'cryptedphone' then
          ...
          TriggerServerEvent('esx_blanchiment:startCraft2Bandits')
        ...
        if data.current.value == 'lightbreak' then
          ...
          TriggerServerEvent('esx_blanchiment:startCraft3Bandits')
...
AddEventHandler('esx_blanchiment:hasEnteredMarkerBandits', function(zone, station, part, partNum)
...
AddEventHandler('esx_blanchiment:hasExitedMarkerBandits', function(zone, station, part, partNum)



  if zone == 'HarvestBandits' then

    TriggerServerEvent('esx_blanchiment:stopHarvestBandits')
  ...
  if zone == 'HarvestBandits2' then
    ...
    TriggerServerEvent('esx_blanchiment:stopHarvest2Bandits')
  ...
  if zone == 'HarvestBandits3' then
    ...
    TriggerServerEvent('esx_blanchiment:stopHarvest3Bandits')

    TriggerServerEvent('esx_blanchiment:stopHarvest4Bandits')
  ...
  if zone == 'CraftBandits' then
    ...
    TriggerServerEvent('esx_blanchiment:stopCraftBandits')

    TriggerServerEvent('esx_blanchiment:stopCraft2Bandits')

    TriggerServerEvent('esx_blanchiment:stopCraft3Bandits')
...
Citizen.CreateThread(function()
  ...
  while true do
    ...
    if PlayerData.job2 ~= nil and PlayerData.job2.name == 'blanchiment' then
    ...
    if PlayerData.job2 ~= nil and PlayerData.job2.name == 'blanchiment' then
      ...
      if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastZone ~= currentZone or LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum) ) then
        ...
        then
          ...
          TriggerEvent('esx_blanchiment:hasExitedMarkerBandits', LastZone, LastStation, LastPart, LastPartNum)
        ...
        TriggerEvent('esx_blanchiment:hasEnteredMarkerBandits', currentZone, currentStation, currentPart, currentPartNum)
...
Citizen.CreateThread(function()
  ...
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'blanchiment' and (GetGameTimer() - GUI.Time) > 300 then
...
AddEventHandler('esx_blanchiment:teleportMarkers', function(position)
...
function OpenGetBlackMoney()
  ...
  ESX.TriggerServerCallback('esx_blanchiment:getBlackMoneySociety', function(inventory)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.type == 'item_weapon' then
          ...
          TriggerServerEvent('esx_blanchiment:getItem', data.current.type, data.current.value, data.current.ammo)
          ...
          ESX.UI.Menu.Open(
            ...
            function(data2, menu)
              ...
              if quantity == nil then
                ...
                TriggerServerEvent('esx_blanchiment:getItem', data.current.type, data.current.value, quantity)
...
function OpenPutBlackMoney()
  ...
  ESX.TriggerServerCallback('esx_blanchiment:getPlayerInventory2', function(inventory)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.type == 'item_weapon' then
          ...
          TriggerServerEvent('esx_blanchiment:putItem', data.current.type, data.current.value, data.current.ammo)
          ...
          ESX.UI.Menu.Open(
            ...
            function(data2, menu)
              ...
              TriggerServerEvent('esx_blanchiment:putItem', data.current.type, data.current.value, tonumber(data2.value))
