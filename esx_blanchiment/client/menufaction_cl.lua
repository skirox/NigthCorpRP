          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                ...
                TriggerServerEvent('esx_blanchiment:handcuff', GetPlayerServerId(player))
              ...
              if data2.current.value == 'drag' then
                ...
                TriggerServerEvent('esx_blanchiment:drag', GetPlayerServerId(player))
              ...
              if data2.current.value == 'put_in_vehicle' then
                ...
                TriggerServerEvent('esx_blanchiment:putInVehicle', GetPlayerServerId(player))
              ...
              if data2.current.value == 'out_the_vehicle' then
                ...
                TriggerServerEvent('esx_blanchiment:OutVehicle', GetPlayerServerId(player))
...
function OpenIdentityCardMenu(player)
  ...
  if Config.EnableESXIdentity then
    ...
    ESX.TriggerServerCallback('esx_blanchiment:getOtherPlayerData', function(data)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil then
          ...
          TriggerServerEvent('esx_blanchiment:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_blanchiment:getVehicleInfos', function(infos)
...
RegisterNetEvent('esx_blanchiment:handcuff')

AddEventHandler('esx_blanchiment:handcuff', function()
...
RegisterNetEvent('esx_blanchiment:drag')
AddEventHandler('esx_blanchiment:drag', function(cop)
...
RegisterNetEvent('esx_blanchiment:putInVehicle')

AddEventHandler('esx_blanchiment:putInVehicle', function()
...
RegisterNetEvent('esx_blanchiment:OutVehicle')

AddEventHandler('esx_blanchiment:OutVehicle', function(t)
...
Citizen.CreateThread(function()
    ...
    while true do
		...
		if IsControlPressed(0,  Keys['F9']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'blanchiment' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'bandits_actions') and (GetGameTimer() - GUI.Time) > 150 then
